  ...
  void * __cdecl realloc( void *pMem, size_t nSize )
{
  ...
  void * __cdecl calloc( size_t nCount, size_t nElementSize )
{
...
size_t __cdecl _msize_dbg( void *pMem, int nBlockUse )
{
  ...
  void *__cdecl _aligned_malloc_base( size_t size, size_t align )
{
	return _malloc_base( size );
}

  void *__cdecl _aligned_realloc_base( void *ptr, size_t size, size_t align )
{
	return _realloc_base( ptr, size );
}

 void __cdecl _aligned_free_base( void *ptr )
{
	_free_base( ptr );
}
...
extern "C"   void * __cdecl _aligned_recalloc( void * memblock, size_t count, size_t size, size_t align )
{
...
extern "C"   void * __cdecl _aligned_offset_recalloc( void * memblock, size_t count, size_t size, size_t align, size_t offset )
{
