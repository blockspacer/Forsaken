...
public:
	...
	virtual int		GetMaxHealth() const { return m_iMaxHealth; } // Forsaken Addition: Max Health
...
private:
	...
	float			m_flMaxspeed;
	int				m_iHealth;
	int				m_iMaxHealth; // Forsaken Addition: Max Health
	...
	// Forsaken Addition
	friend class CForsakenGameMovement;
