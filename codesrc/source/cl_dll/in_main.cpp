...
{	
	...
	// We shouldn't be telling the game that there is no side movement either.
	if (cmd->buttons & IN_SPRINT && !(cmd->buttons & IN_LEAN) && ToForsakenPlayer(C_BasePlayer::GetLocalPlayer())->GetMaxSprint() > 0)
		cmd->sidemove = 0.0f;
