...
// Internal Classes
class CForsakenHudWeaponSelection : public CBaseHudWeaponSelection, public vgui::Panel
{
	DECLARE_CLASS_SIMPLE( CForsakenHudWeaponSelection, vgui::Panel );

public:
	CForsakenHudWeaponSelection(const char *pElementName );
...
// HL2 Class Macros
DECLARE_HUDELEMENT( CForsakenHudWeaponSelection );

// Constructor & Deconstructor
CForsakenHudWeaponSelection::CForsakenHudWeaponSelection( const char *pElementName ) : 
CBaseHudWeaponSelection(pElementName), BaseClass(NULL, "ForsakenHudWeaponSelection")
{
...
//-----------------------------------------------------------------------------
void CForsakenHudWeaponSelection::OnWeaponPickup( C_BaseCombatWeapon *pWeapon )
{
...
//-----------------------------------------------------------------------------
void CForsakenHudWeaponSelection::OnThink( void )
{
...
//-----------------------------------------------------------------------------
bool CForsakenHudWeaponSelection::ShouldDraw()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CForsakenHudWeaponSelection::LevelInit()
{
...
//-------------------------------------------------------------------------
void CForsakenHudWeaponSelection::Paint()
{
	if (!ShouldDraw())
		return;
...
//-----------------------------------------------------------------------------
void CForsakenHudWeaponSelection::DrawBox(int x, int y, int wide, int tall, Color color, float normalizedAlpha, int number)
{
...
//-----------------------------------------------------------------------------
void CForsakenHudWeaponSelection::ApplySchemeSettings(vgui::IScheme *pScheme)
{
...
//-----------------------------------------------------------------------------
void CForsakenHudWeaponSelection::OpenSelection( void )
{
...
//-----------------------------------------------------------------------------
void CForsakenHudWeaponSelection::HideSelection( void )
{
...
//-----------------------------------------------------------------------------
C_BaseCombatWeapon *CForsakenHudWeaponSelection::FindNextWeaponInWeaponSelection(int iCurrentSlot, int iCurrentPosition)
{
	C_BasePlayer *pPlayer = C_BasePlayer::GetLocalPlayer();
	if ( !pPlayer )
		return NULL;
...
//-----------------------------------------------------------------------------
C_BaseCombatWeapon *CForsakenHudWeaponSelection::FindPrevWeaponInWeaponSelection(int iCurrentSlot, int iCurrentPosition)
{
	C_BasePlayer *pPlayer = C_BasePlayer::GetLocalPlayer();
	if ( !pPlayer )
		return NULL;
...
//-----------------------------------------------------------------------------
void CForsakenHudWeaponSelection::CycleToNextWeapon( void )
{
...
//-----------------------------------------------------------------------------
void CForsakenHudWeaponSelection::CycleToPrevWeapon( void )
{
	// Get the local player.
	C_BasePlayer *pPlayer = C_BasePlayer::GetLocalPlayer();
	if ( !pPlayer )
...
//-----------------------------------------------------------------------------
C_BaseCombatWeapon *CForsakenHudWeaponSelection::GetWeaponInSlot( int iSlot, int iSlotPos )
{
...
//-----------------------------------------------------------------------------
void CForsakenHudWeaponSelection::FastWeaponSwitch( int iWeaponSlot )
{
...
//-----------------------------------------------------------------------------
void CForsakenHudWeaponSelection::SelectWeaponSlot( int iSlot )
{
