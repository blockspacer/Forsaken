...
//	virtual void OnCommand( const char *command );
	...
	// Forsaken Addition: Forsaken HUD elements.
	vgui::Label *m_pCivNutritionResources;
	vgui::Label *m_pCivOrdinanceResources;
	vgui::Label *m_pGovNutritionResources;
	vgui::Label *m_pGovOrdinanceResources;
	vgui::Label *m_pRelNutritionResources;
	vgui::Label *m_pRelOrdinanceResources;
