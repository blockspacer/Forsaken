...
// Forsaken Addition: Credits hide HUD.
#define HIDEHUD_CREDITS				( 1<<11 )

// Forsaken Addition: Increased bit count of HIDEHUD.
...
enum PLAYER_ANIM
{
	...
	PLAYER_ATTACK1,
	PLAYER_ATTACK2,
	PLAYER_MELEE_ATTACK1,
	PLAYER_MELEE_ATTACK2,
	PLAYER_IN_VEHICLE,

	// Forsaken Addition: Player Animations
	PLAYER_FSKN_LEANLEFT,
	PLAYER_FSKN_LEANRIGHT,
	PLAYER_FSKN_SPRINT,
