...
//HL2MP
	...
	// Forsaken Addition: Registering of custom actions.
	REGISTER_SHARED_ACTIVITY(ACT_FSKN_FIRE);
	REGISTER_SHARED_ACTIVITY(ACT_FSKN_KICK);
	REGISTER_SHARED_ACTIVITY(ACT_FSKN_LEANLEFT);
	REGISTER_SHARED_ACTIVITY(ACT_FSKN_LEANRIGHT);
	REGISTER_SHARED_ACTIVITY(ACT_FSKN_SPRINT);
	REGISTER_SHARED_ACTIVITY(ACT_VM_MISS);
	REGISTER_SHARED_ACTIVITY(ACT_VM_KICK);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SPRINT);
	REGISTER_SHARED_ACTIVITY(ACT_VM_TOZOOM);
	REGISTER_SHARED_ACTIVITY(ACT_VM_FROMZOOM);
	REGISTER_SHARED_ACTIVITY(ACT_VM_MELEE_SLASH);
	REGISTER_SHARED_ACTIVITY(ACT_VM_MELEE_STAB);
	REGISTER_SHARED_ACTIVITY(ACT_VM_MELEE_MISS);
	REGISTER_SHARED_ACTIVITY(ACT_VM_MELEE_STAB_MISS);
