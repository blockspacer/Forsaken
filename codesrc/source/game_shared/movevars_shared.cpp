...
ConVar	sv_maxspeed		( "sv_maxspeed", "187.5", FCVAR_NOTIFY | FCVAR_REPLICATED);

#ifdef _XBOX
	ConVar	sv_accelerate	( "sv_accelerate", "7", FCVAR_NOTIFY | FCVAR_REPLICATED);
#else
ConVar	sv_accelerate	( "sv_accelerate", "7.5", FCVAR_NOTIFY | FCVAR_REPLICATED);
#endif//_XBOX

ConVar	sv_airaccelerate(  "sv_airaccelerate", "2", FCVAR_NOTIFY | FCVAR_REPLICATED);    
