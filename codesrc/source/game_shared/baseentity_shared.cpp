...
// Forsaken Addition: Made IsMoving available on player client-side.
bool CBaseEntity::IsMoving()
{ 
	Vector velocity;

	// Forsaken Addition: Valve had this going to a helper function, but since this is both client/server now we can short circuit.
	if (GetMoveType() == MOVETYPE_VPHYSICS)
		m_pPhysicsObject->GetVelocity(&velocity, NULL);
	else
