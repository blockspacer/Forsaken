...
// Forsaken Addition: Additional include files.
...
Panel *EditablePanel::CreateControlByName(const char *controlName)
{
	...
	/*
		Forsaken Addition
		The code block below is a temporary work around for the CBuildFactoryHelper 
		class not being able to runtime create the available controls list. The root 
		cause of this is due to how VS2003 links in .LIB files as opposed to .OBJ 
		files. The true solution to this is migrating to VS2005 and using the feature 
		"link LIB files as OBJs". In order for this to work, Valve must initiate support 
		for VS2005.
	*/
	if (Q_stricmp(controlName, "AnimatingImagePanel") == 0)
		return new AnimatingImagePanel(NULL, NULL);
	else if (Q_stricmp(controlName, "BitmapImagePanel") == 0)
		return new CBitmapImagePanel(NULL, NULL, "BitmapImagePanel");
	else if (Q_stricmp(controlName, "Button") == 0)
		return new Button(NULL, NULL, "Button");
	else if (Q_stricmp(controlName, "CheckButton") == 0)
		return new CheckButton(NULL, NULL, "CheckButton");
	else if (Q_stricmp(controlName, "ComboBox") == 0)
		return new ComboBox(NULL, NULL, 5, true);
	else if (Q_stricmp(controlName, "Divider") == 0)
		return new Divider(NULL, NULL);
	else if (Q_stricmp(controlName, "EditablePanel") == 0)
		return new EditablePanel(NULL, NULL);
	else if (Q_stricmp(controlName, "ExpandButton") == 0)
		return new ExpandButton(NULL, NULL);
	else if (Q_stricmp(controlName, "GraphPanel") == 0)
		return new GraphPanel(NULL, NULL);
	else if (Q_stricmp(controlName, "ImagePanel") == 0)
		return new ImagePanel(NULL, NULL);
	else if (Q_stricmp(controlName, "Label") == 0)
		return new Label(NULL, NULL, "Label");
	else if (Q_stricmp(controlName, "ListPanel") == 0)
		return new ListPanel(NULL, NULL);
	else if (Q_stricmp(controlName, "ListViewPanel") == 0)
		return new ListViewPanel(NULL, NULL);
	else if (Q_stricmp(controlName, "Menu") == 0)
		return new Menu(NULL, NULL);
	else if (Q_stricmp(controlName, "MenuBar") == 0)
		return new MenuBar(NULL, NULL);
	else if (Q_stricmp(controlName, "MenuButton") == 0)
		return new MenuButton(NULL, NULL, "MenuButton");
	else if (Q_stricmp(controlName, "MenuItem") == 0)
		return new MenuItem(NULL, NULL, "MenuItem");
	else if (Q_stricmp(controlName, "MessageBox") == 0)
		return new MessageBox("MessageBox", "MessageBoxText");
	else if (Q_stricmp(controlName, "Panel") == 0)
		return new Panel(NULL, NULL);
	else if (Q_stricmp(controlName, "PropertySheet") == 0)
		return new PropertySheet(NULL, NULL);
	else if (Q_stricmp(controlName, "ProgressBar") == 0)
		return new ProgressBar(NULL, NULL);
	else if (Q_stricmp(controlName, "RadioButton") == 0)
		return new RadioButton(NULL, NULL, "RadioButton");
	else if (Q_stricmp(controlName, "RichText") == 0)
		return new RichText(NULL, NULL);
	else if (Q_stricmp(controlName, "ScrollBar_Vertical") == 0)
		return new ScrollBar(NULL, NULL, true);
	else if (Q_stricmp(controlName, "ScrollBar_Horizontal") == 0)
		return new ScrollBar(NULL, NULL, false);
	else if (Q_stricmp(controlName, "TextEntry") == 0)
		return new TextEntry(NULL, NULL);
	else if (Q_stricmp(controlName, "ToggleButton") == 0)
		return new ToggleButton(NULL, NULL, "ToggleButton");
	else if (Q_stricmp(controlName, "TreeView") == 0)
		return new TreeView(NULL, NULL);
	else if (Q_stricmp(controlName, "CTreeViewListControl") == 0)
		return new CTreeViewListControl(NULL, NULL);
	else if (Q_stricmp(controlName, "URLLabel") == 0)
