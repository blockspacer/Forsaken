...
public:
	...
	// Forsaken Addition: Set ammo.
	int					SetAmmo( int iCount, int iAmmoIndex, bool bSuppressSound = false );
	int					SetAmmo( int iCount, const char *szName, bool bSuppressSound = false );
