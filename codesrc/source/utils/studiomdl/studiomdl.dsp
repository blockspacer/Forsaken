...
# Begin Custom Build - copy to ..\..\..\game\bin\studiomdl.exe
TargetDir=.\Release
...
"..\..\..\game\bin\studiomdl.exe" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	if exist ..\..\..\game\bin\studiomdl.exe attrib -r ..\..\..\game\bin\studiomdl.exe 
	copy $(TargetPath) ..\..\..\game\bin\studiomdl.exe 
